...
| **F0.1** | Design da fundação (**esta fatia**) | `arquiteto-lider` | Contrato API v1, data-model, backlog, ADRs 0001–0007, devcontainer-assessment. | — | Docs em `docs/` revisados; decisões e questões abertas registradas. | n/a (design) | — | M |
...
| **F0.5** | Tooling de qualidade frontend | `engenheiro-frontend` | ESLint, Prettier, `tsc` strict, Vitest+coverage (≥70%). | F0.2 | lint/type/test rodam no container. | Vitest exemplo verde. | — | P |
